...
export const industries = [
  {
    ...
    icon: <Building2 className="w-10 h-10 text-[#003580]" />,
  ...
  },
  {
    ...
    icon: <Hammer className="w-10 h-10 text-[#003580]" />,
  ...
  },
  {
    ...
    icon: <HeartPulse className="w-10 h-10 text-[#003580]" />,
    category: "Healthcare",
    featured: true
  },
  {
    ...
    icon: <Laptop className="w-10 h-10 text-[#003580]" />,
    category: "Technology",
    featured: true
  },
  {
    ...
    icon: <ShoppingCart className="w-10 h-10 text-[#003580]" />,
  ...
  },
  {
    ...
    icon: <Factory className="w-10 h-10 text-[#003580]" />,
  ...
  },
  {
    ...
    icon: <Scale className="w-6 h-6 text-[#003580]" />,
  ...
  },
  {
    ...
    icon: <Heart className="w-6 h-6 text-[#003580]" />,
    category: "Non-Profit",
    featured: false
  },
  {
    ...
    icon: <Utensils className="w-6 h-6 text-[#003580]" />,
  ...
  },
  {
    ...
    icon: <Leaf className="w-6 h-6 text-[#003580]" />,
  ...
  },
  {
    ...
    icon: <Plane className="w-6 h-6 text-[#003580]" />,
    category: "Logistics",
    featured: false
  },
  {
    ...
    icon: <GraduationCap className="w-6 h-6 text-[#003580]" />,
    category: "Education",
    featured: false
  },
  {
    ...
    icon: <Sprout className="w-6 h-6 text-[#003580]" />,
  ...
  },
  {
    ...
    icon: <Film className="w-6 h-6 text-[#003580]" />,
    category: "Media & Ent.",
    featured: false
  },
  {
    ...
    icon: <Users className="w-6 h-6 text-[#003580]" />,
                ...
                <button 
                  ...
                  className={`transition-colors duration-300 pb-1 border-b-2 ${
                    activeCategory === cat 
                      ...
                      : "text-slate-500 hover:text-[#003580] border-transparent"
                  }`}
                >
                  {cat}
                </button>
          ...
          {filteredIndustries.map((item, i) => (
            item.featured ? (
              ...
              >
                ...
                <div className="mb-6 inline-flex items-center justify-center w-14 h-14 rounded-xl bg-[#003580]/5 text-[#003580] group-hover:bg-[#003580] group-hover:text-white transition-colors duration-300">
                  {item.icon}
                </div>
              ...
              >
                ...
                <div>
                  <h4 className="font-bold text-base text-[#003580] mb-1">{item.title}</h4>
