...
export const keywordOwnershipRules = [
  ...
  },
  {
    ...
    supportingUrls: ["/quickbooks-bookkeeping-services", "/texas/katy-bookkeeping-services", "/texas/houston-bookkeeping-cleanup"],
  ...
  },
  {
    ...
    supportingUrls: ["/business-tax-accounting", "/payroll-tax-support", "/services", "/texas/round-rock-llc-accountant"],
  ...
  {
    intent: "LLC accountant Round Rock TX",
    ownerUrl: "/texas/round-rock-llc-accountant",
    supportingUrls: ["/llc-formation-tax-setup", "/business-tax-accounting", "/texas-tax-accounting-services"],
    preferredAnchor: "LLC Accountant in Round Rock, TX",
    boundary: "Local LLC bookkeeping, accounting, tax-preparation, and compliance intent for Round Rock owners.",
  },
  {
    intent: "Payroll tax support",
    ownerUrl: "/payroll-tax-support",
    supportingUrls: ["/business-tax-accounting", "/llc-formation-tax-setup", "/services", "/texas/sugar-land-payroll-services"],
    preferredAnchor: "Payroll Tax Support",
    boundary: "Employer records, deposits, filings, wage forms, and payroll-notice workflow.",
  },
  {
    intent: "Bookkeeping services for small business",
    ownerUrl: "/small-business-bookkeeping-services",
    supportingUrls: ["/quickbooks-bookkeeping-services", "/bookkeeping-cleanup", "/business-tax-accounting", "/services"],
    preferredAnchor: "Bookkeeping Services for Small Business",
    boundary: "Recurring monthly and outsourced bookkeeping; historical cleanup and platform-specific QuickBooks intent remain separate.",
  },
  {
    intent: "Payroll services Sugar Land TX",
    ownerUrl: "/texas/sugar-land-payroll-services",
    supportingUrls: ["/payroll-tax-support", "/texas/sugar-land-small-business-accountant", "/texas-tax-accounting-services"],
    preferredAnchor: "Payroll Services in Sugar Land, TX",
    boundary: "Local payroll-record coordination, bookkeeping alignment, employment-tax workflow, and year-end wage-record intent.",
  },
  {
    intent: "Bookkeeping cleanup Houston TX",
    ownerUrl: "/texas/houston-bookkeeping-cleanup",
    supportingUrls: ["/bookkeeping-cleanup", "/quickbooks-bookkeeping-services", "/texas/houston-tax-accountant"],
    preferredAnchor: "Bookkeeping Cleanup in Houston, TX",
    boundary: "Local historical cleanup, catch-up, reconciliation, and tax-ready record intent; not recurring Houston bookkeeping.",
  },
  {
    intent: "Business tax preparation Fort Worth TX",
    ownerUrl: "/texas/fort-worth-small-business-tax-preparation",
    supportingUrls: ["/business-tax-accounting", "/texas/fort-worth-catch-up-bookkeeping", "/texas-tax-accounting-services"],
    preferredAnchor: "Business Tax Preparation in Fort Worth, TX",
    boundary: "Local entity return-preparation intent for Fort Worth owner-managed businesses; bookkeeping cleanup remains separate.",
  },
  {
