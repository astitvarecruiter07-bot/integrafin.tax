...
export default function CaseStudyClient() {
  ...
  return (
    <div className="bg-[#f7f9fc]">
      ...
      <section className="relative min-h-[520px] pt-32 pb-20 flex items-center justify-center hero-gradient overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-black text-white leading-tight tracking-tighter mb-6 max-w-4xl mx-auto">
          ...
          <p className="text-slate-400 text-lg md:text-xl font-light max-w-2xl mx-auto mb-12">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-16">
            {stats.map((stat, index) => (
              <div key={index} className="bg-white/5 backdrop-blur-md border border-white/10 px-6 py-4 rounded-xl flex flex-col items-center">
      ...
      <section className="bg-[#003580] py-24">
          ...
          <div className="grid lg:grid-cols-12 gap-0 overflow-hidden rounded-3xl bg-white/5 backdrop-blur-xl border border-white/10 shadow-2xl shadow-blue-900/40 group">
            <div className="lg:col-span-5 relative min-h-[400px]">
              ...
              <div className="absolute inset-0 p-12 flex flex-col justify-between">
                ...
                <div className="bg-[#00C2CB]/90 p-8 w-48 h-48 rounded-full flex flex-col items-center justify-center text-[#003580] shadow-2xl">
                  <span className="text-4xl font-black tracking-tighter leading-none">30%</span>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 space-y-4">
            <div>
              ...
              <h2 className="text-4xl font-black text-[#0047AB] tracking-tight">Projects We Have Done</h2>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredStudies.map((study, index) => (
              <div 
                key={index} 
                className="group bg-white rounded-2xl p-8 shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl flex flex-col h-full border-t-4 border-transparent hover:border-[#00C2CB]"
              >
                <div className="mb-8">
