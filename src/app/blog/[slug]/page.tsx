...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  const canonicalUrl = `https://integrafin.tax/blog/${slug}`;
      ...
      <article className="pt-32 pb-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          <div className="mt-10 sm:mt-12 p-5 sm:p-8 bg-accent-light rounded-2xl text-center">
            ...
            <p className="text-text-secondary mb-5">IntegraFin&apos;s team of tax and financial experts is here to help.</p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            dateModified: (post as { updatedAt?: string }).updatedAt || post.date,
