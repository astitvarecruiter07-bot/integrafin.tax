...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const routes = [
    ...
    { path: '/texas/round-rock-llc-accountant', lastModified: '2026-08-01', priority: 0.8 },
    { path: '/texas/sugar-land-payroll-services', lastModified: '2026-08-01', priority: 0.8 },
    { path: '/texas/houston-bookkeeping-cleanup', lastModified: '2026-08-01', priority: 0.8 },
    { path: '/texas/fort-worth-small-business-tax-preparation', lastModified: '2026-08-01', priority: 0.8 },
    ...
    { path: '/tax-calculator', lastModified: '2026-08-06', priority: 0.9 },
    { path: '/quarterly-estimated-tax-calculator', lastModified: '2026-08-06', priority: 0.9 },
